		...
		bus.on('Winner', (e) => {
			...
			switch (e.win_type) {
				case 'Heartland reached':
					this.type_of_victory = 'Your God has reached the heathen heartland, and converts the enemy to the one true faith.'
				...
				case 'Faith extinguished':
					this.type_of_victory = 'You have snuffed out your opponent’s divine inspiration, leaving them faithless to continue.'
					...
					break;
				case 'Only one piece left':
					this.type_of_victory = 'You have left your opponent with only one pitiful believer, immobilized and helpless.'
					break;
				default:
